...
//                 ))}
//             </div>
//             <button onClick={bookAppointment} className='bg-primary text-sm text-white font-light px-14 py-3 rounded-full my-4 mt-7'>Book An Appointment</button>
  ...
  return docInfo && (
    <div>
        ...
        <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
            ...
            <button className='bg-primary text-sm text-white font-light px-14 py-3 rounded-full mymy-4 mt-7'>Book An Appointement</button>
        </div>
